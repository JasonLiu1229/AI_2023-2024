...
% Student information
\newcommand*{\myname}{My name}			% TODO: Fill in
\newcommand*{\mystudentnumber}{s0}		% TODO: Fill in
...
\begin{document}	
	\begin{questions}
		...
		% TODO: Fill in
		\begin{parts}
			\part \prob{+b \mid +a}			= \fillin[My answer]
			\part \prob{+a, +b}				= \fillin[]
			\part \prob{+a \mid +b}			= \fillin[]
