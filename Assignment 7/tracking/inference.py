...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation: int, gameState: busters.GameState):
        ...
        dist = DiscreteDistribution()
        for p in self.particles:
            dist[p] += self.getObservationProb(observation, gameState.getPacmanPosition(), p,
    ...
    def elapseTime(self, gameState):
        ...
        newParticles = []
        for p in self.particles:
            newParticles.append(self.getPositionDistribution(gameState, p).sample())
...
class JointParticleFilter(ParticleFilter):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for p in self.particles:
            ...
            for i in range(self.numGhosts):
                prob *= self.getObservationProb(observation[i], gameState.getPacmanPosition(), p[i],
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            "*** YOUR CODE HERE ***"
            for i in range(self.numGhosts):
                newDist = self.getPositionDistribution(gameState, oldParticle, i, self.ghostAgents[i])
